...
-- Dumping structure for table boundaries.area
CREATE TABLE IF NOT EXISTS `area` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_area_property1_idx` (`property_id`),
  CONSTRAINT `fk_area_property1` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table boundaries.area: ~0 rows (approximately)
/*!40000 ALTER TABLE `area` DISABLE KEYS */;
REPLACE INTO `area` (`id`, `length`, `width`, `property_id`) VALUES
	(1, 2000, 3000, 1);
/*!40000 ALTER TABLE `area` ENABLE KEYS */;


-- Dumping structure for table boundaries.bedrooms
CREATE TABLE IF NOT EXISTS `bedrooms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `no_of_bedrooms` varchar(45) DEFAULT NULL,
  `property_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_bedrooms_property1_idx` (`property_id`),
  CONSTRAINT `fk_bedrooms_property1` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table boundaries.bedrooms: ~0 rows (approximately)
/*!40000 ALTER TABLE `bedrooms` DISABLE KEYS */;
REPLACE INTO `bedrooms` (`id`, `no_of_bedrooms`, `property_id`) VALUES
	(1, '5', 1);
...
-- Dumping structure for table boundaries.parking
CREATE TABLE IF NOT EXISTS `parking` (
  `id` int(11) NOT NULL,
  `available` tinyint(1) DEFAULT NULL,
  `property_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_parking_property1_idx` (`property_id`),
  CONSTRAINT `fk_parking_property1` FOREIGN KEY (`property_id`) REFERENCES `property` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table boundaries.parking: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `property` (
  ...
  KEY `fk_property_property_types1_idx` (`property_types_id`),
  CONSTRAINT `user_id` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_property_property_types1` FOREIGN KEY (`property_types_id`) REFERENCES `property_types` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- Dumping data for table boundaries.property: ~9 rows (approximately)
/*!40000 ALTER TABLE `property` DISABLE KEYS */;
REPLACE INTO `property` (`id`, `name`, `user`, `description`, `image`, `price`, `lat`, `lon`, `property_types_id`) VALUES
	(1, 'My home', 1, 'An independent house in hennur', 'uploads/propertyImage1468761835.jpg', 3000000, NULL, NULL, 1);
